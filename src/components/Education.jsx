...
const Education = () => {
    ...
    return (
        <div name="education" className="md:pt-10 pt-20 w-full bg-gradient-to-b from-gray-800 to-black text-white">
            <div className="max-w-screen-lg flex flex-col justify-center p-5 mx-auto h-fit md:h-screen">
                <div className="py-5">
                    <p className="text-4xl font-bold inline border-b-4 border-gray-500">Education</p>
                </div>
                {
                    education.map(({ school, course, marks, year }) => (
                        <div key={course} className="md:w-4/5 shadow-md shadow-gray-600 rounded-lg duration-200 hover:scale-105 px-10 py-5 my-5 mx-auto w-full">
