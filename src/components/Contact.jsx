...
const Contact = () => {
    return (
        <div name="contact" className="pt-20 pb-5 bg-gradient-to-b from-slate-900 to-slate-700 min-h-screen text-white">
            <div className="max-w-screen-lg mx-auto flex justify-center flex-col md:min-h-screen px-4">
                ...
                <div className=" flex justify-center items-center">
                    <form action="https://getform.io/f/paqgxooa" method="POST" className=" flex flex-col w-5/6 md:w-1/2">
