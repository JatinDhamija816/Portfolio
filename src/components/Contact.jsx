...
const Contact = () => {
    return (
        <div name="contact" className="pt-20 w-full bg-gradient-to-b from-black to-gray-800 text-white">
            <div className="flex flex-col p-5 justify-center max-w-screen-lg mx-auto">
                <div className="pb-8">
                ...
                <div className=" flex justify-center items-center">
                    <form action="https://getform.io/f/paqgxooa" method="POST" className=" flex flex-col w-full md:w-1/2">
